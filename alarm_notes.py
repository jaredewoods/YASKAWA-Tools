...
class AlarmAnalyzer:
    ...
    def setup_comboboxes(self, label_font, entry_font):
        ...
        separator.grid(row=2, columnspan=4, sticky='ew', padx=5, pady=5)
        # Add label for tech notes
        ttk.Label(self.master, text="TECH NOTES", font=label_font, anchor="center", foreground="blue").grid(row=0, column=3, padx=5, pady=5, sticky='nsew')
